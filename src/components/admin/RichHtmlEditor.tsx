...
export default function RichHtmlEditor({
  ...
  return (
    <div className="rich-ui-editor">
      <label className="ui-label">{label}</label>

      <div className="rich-ui-editor__shell">
        <div className="rich-ui-editor__toolbar">
          <button
            type="button"
        ...
        {sourceMode ? (
          <textarea
            ref={sourceRef}
            className="rich-ui-editor__source"
            style={{ minHeight }}
            value={sourceValue}
            onChange={(e) => {
          ...
          <div
            ref={ref}
            className="rich-ui-editor__content"
            contentEditable
