// Very small, legacy-oriented HTML decoder/sanitizer.
//
// Legacy ZOB tables sometimes store HTML with odd entity usage (e.g. "<&sol;b>")
...
/**
 * Convert legacy notes into safe-ish HTML for rendering.
 ...
 */
export function legacyToHtml(input: any): string {
